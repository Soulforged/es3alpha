defmodule Es3Alpha.RestHandlers.Files do
  ...
  def allowed_methods(req, state), do: {["GET", "OPTIONS", "HEAD", "POST"], req, state}
  ...
  def content_types_provided(req, state) do
    {[{"application/json", :files_to_json}, {"text/plain", :files_to_text}], req, state}
  end
  ...
  def files_to_text(req, state) do
    files_to_json(req, state)
  end
end
